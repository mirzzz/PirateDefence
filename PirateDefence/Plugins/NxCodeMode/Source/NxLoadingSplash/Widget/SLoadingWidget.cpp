...
SThrobber::EAnimation SLoadingWidget::GetThrobberAnimation(const FNxThrobberSettings& ThrobberSettings) const
{
...
void SLoadingWidget::ConstructLoadingIcon(const FNxLoadingWidgetSettings& Settings)
{
	if (Settings.LoadingIconType == E_LoadingIconType::LIT_ImageSequence)
	{
	...
	else if (Settings.LoadingIconType == E_LoadingIconType::LIT_CircularThrobber)
	{
